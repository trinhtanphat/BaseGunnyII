...
namespace Game.Base.Packets
{
    public interface IPacketLib
    {
        ...
        GSPacketIn SendPlayerCardInfo(PlayerInfo player, List<ItemInfo> items);
        GSPacketIn SendUpdatePetInfo(PlayerInfo player, List<ItemInfo> items);
        //房间列表
