...
namespace Game.Server.Packets.Server
{
    public class ConsolePacketLib : IPacketLib
    {
        ...
        public GSPacketIn SendOpenHoleComplete(Game.Server.GameObjects.GamePlayer player, int type, bool result)
        {
            throw new NotImplementedException();
        }
        ...
        public GSPacketIn SendPlayerCardInfo(SqlDataProvider.Data.PlayerInfo player, List<SqlDataProvider.Data.ItemInfo> items)
        {
            throw new NotImplementedException();
        }
