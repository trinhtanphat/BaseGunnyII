...
public class NewTrainingBoss25002 : ABrain
{
	...
	private static string[] listChat = new string[3] { "Ý! Bị đánh đến vầy sao！", "Chỉ là một đứa nhóc mà mạnh vậy sao?!", "Ta đến báo thù đây, cẩn thận！" };
	...
	public void MoveToPlayer(Player player)
	{
		...
		if (player.Y < 420 && player.X < 210)
		{
			if (base.Body.Y > 420)
			{
				base.Body.MoveTo(base.Body.X - num, base.Body.Y, "walk", 1200, "", ((SimpleBoss)base.Body).NpcInfo.speed, MoveBeat);
			}
		...
		else if (base.Body.Y < 420)
		{
			...
			{
				base.Body.MoveTo(200, base.Body.Y, "walk", 1200, "", ((SimpleBoss)base.Body).NpcInfo.speed, Fall);
			}
		}
		else if (player.X > base.Body.X)
		{
