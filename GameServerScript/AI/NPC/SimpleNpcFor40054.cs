	...
	public void MoveToPlayer(Player player)
	{
		...
		if (player.Y < 420 && player.X < 210)
		{
			if (base.Body.Y > 420)
			{
				...
				{
					base.Body.MoveTo(25, base.Body.Y, "fly", 1200, "", 3, MoveBeat);
				}
				else
				{
					base.Body.MoveTo(base.Body.X - num, base.Body.Y, "fly", 1200, "", 3, MoveBeat);
				}
			}
		...
		else if (base.Body.Y < 420)
		{
			...
			{
				base.Body.MoveTo(200, base.Body.Y, "fly", 1200, "", 3, MoveBeat);
			}
		}
		else if (player.X > base.Body.X)
		{
