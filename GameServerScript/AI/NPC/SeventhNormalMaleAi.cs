...
public class SeventhNormalMaleAi : ABrain
{
	...
	private static string[] listChat = new string[8] { "Đừng để họ vượt qua !", "Cướp vũ khí của chúng mau lên", "Hạ hết vũ khí xuống!", "Tiêu diệt kẻ thù!", "Còn ngoan cố chúng tôi sẻ không tha", "Đối với chiến thắng đệm Boo! Brothers phí!", "Nhanh chóng tiêu diệt kẻ thù! ", "Với sức mạnh số 1! " };
	...
	public void MoveToPlayer(Player player)
	{
		...
		if (player.Y < 420 && player.X < 210)
		{
			if (base.Body.Y > 420)
			{
				...
				{
					base.Body.MoveTo(25, base.Body.Y, "walk", 1200, "", 3, Beating);
				}
				else
				{
