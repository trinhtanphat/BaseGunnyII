...
public class FourNormalCycLoneNpc : ABrain
{
	...
	public void BestC()
	{
		...
		base.Body.RangeAttacking(num, num, "cry", 4000, null);
	...
	public void CreateChild()
	{
		...
		((SimpleBoss)base.Body).CreateChild(npcID, x, 700, 400, 2, -1);
	}

	public void CreateChild2()
	{
		int x = base.Game.Random.Next(340, 340);
		((SimpleBoss)base.Body).CreateChild(npcID2, x, 700, 400, 1, 1);
	}
