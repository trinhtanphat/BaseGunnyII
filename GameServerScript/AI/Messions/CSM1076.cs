...
public class CSM1076 : AMissionControl
{
	...
	public override void OnStartGame()
	{
		...
		m_king = base.Game.CreateBoss(m_state, 750, 668, -1, 0, "");
	...
	public override bool CanGameOver()
	{
		...
		{
			m_kingMoive = base.Game.Createlayer(0, 0, "moive", "game.asset.living.BossBgAsset", "out", 1, 0);
		...
		if (m_secondKing != null && !m_secondKing.IsLiving)
		{
			...
			if (m_leftWall != null)
			{
				base.Game.RemovePhysicalObj(m_leftWall[0], sendToClient: true);
			}
			if (m_rightWall != null)
			{
				base.Game.RemovePhysicalObj(m_rightWall[0], sendToClient: true);
			}
			m_kill++;
			return true;
		}
	...
	{
		base.OnGameOver();
		if (m_state == 6 && !m_secondKing.IsLiving)
		{
