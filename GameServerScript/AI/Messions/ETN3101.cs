...
public class ETN3101 : AMissionControl
{
	...
	public override void OnPrepareNewSession()
	{
		...
		int[] npcIds = new int[2] { blueNpcID, redNpcID };
	...
	public override void OnStartGame()
	{
		...
		redTotalCount++;
		boss = base.Game.CreateBoss(blueNpcID, 1300, 444, -1, 1, "");
	...
	{
		base.CanGameOver();
		if (base.Game.GetLivedLivings().Count != 0 || boss.IsLiving || base.Game.TotalKillCount != 15)
		{
			return false;
		}
	...
	{
		base.OnGameOver();
		if (base.Game.GetLivedLivings().Count == 0 && boss != null && !boss.IsLiving)
		{
			base.Game.IsWin = true;
		}
		else
		...
		list.Add(new LoadingFileInfo(2, "image/map/show2.jpg", ""));
