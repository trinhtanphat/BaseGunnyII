...
public class DCT4303 : AMissionControl
{
	...
	private static string[] KillChat = new string[3] { "Mathias không kiểm soát tôi!", "Đây là thách thức số phận của tôi!", "Không! !Đây không phải là ý chí của tôi ..." };

	private static string[] ShootedChat = new string[2] { "Tên nhóc kia, xem ta trừng trị mi!", "Ta đỡ!!!" };
	...
	public override void OnPrepareNewSession()
	{
		...
		int[] npcIds = new int[4] { firstBossID, secondBossID, npcID, npcID2 };
	...
	public override void OnStartGame()
	{
		...
		m_kingFront = base.Game.Createlayer(1100, 600, "font", "game.asset.living.emozhanshiAsset", "out", 1, 0);
	...
	public override void OnShooted()
	{
		if (IsSay == 0)
		{
			...
			{
				int num = base.Game.Random.Next(0, ShootedChat.Length);
				m_secondKing.Say(ShootedChat[num], 0, 1500);
			}
			IsSay = 1;
		}
	}
