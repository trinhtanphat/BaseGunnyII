...
public class Labyrinth40015 : AMissionControl
{
	...
	private PhysicalObj m_gate;

	private int kill = 0;

	private int npcIDs = 40021;

	private int[] birthX = new int[10] { 950, 970, 990, 1010, 1030, 1050, 1070, 1090, 1110, 1130 };
	...
	public override void OnStartGame()
	{
		...
		{
			someNpc.Add(base.Game.CreateNpc(npcIDs, birthX[i], 400, -1, 1));
		}
	}
