...
public class WeakMulticastDelegate
{
	...
	protected bool Equals(Delegate realDelegate)
	{
		if (weakRef == null)
		{
			if (realDelegate.Target == null && (object)method == realDelegate.Method)
			{
				return true;
			}
			return false;
		}
		if (weakRef.Target == realDelegate.Target && (object)method == realDelegate.Method)
		{
			return true;
		}
		return false;
	...
	public override string ToString()
	{
		...
		return new StringBuilder(64).Append("method: ").Append(((object)type == null) ? "(null)" : type.FullName).Append('.')
			.Append(((object)method == null) ? "(null)" : method.Name)
			.Append(" target: ")
