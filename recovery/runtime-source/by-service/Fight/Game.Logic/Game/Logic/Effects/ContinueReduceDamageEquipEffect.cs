...
public class ContinueReduceDamageEquipEffect : BasePlayerEffect
{
	...
	{
		if (living.EffectList.GetOfType(eEffectType.ContinueReduceBaseDamageEquipEffect) is ContinueReduceDamageEquipEffect continueReduceDamageEquipEffect)
		{
			continueReduceDamageEquipEffect.m_probability = ((m_probability > continueReduceDamageEquipEffect.m_probability) ? m_probability : continueReduceDamageEquipEffect.m_probability);
			return true;
		}
