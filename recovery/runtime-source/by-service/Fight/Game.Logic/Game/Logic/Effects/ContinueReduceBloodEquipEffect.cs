...
public class ContinueReduceBloodEquipEffect : BasePlayerEffect
{
	...
	{
		if (living.EffectList.GetOfType(eEffectType.ContinueReduceBloodEquipEffect) is ContinueReduceBloodEquipEffect continueReduceBloodEquipEffect)
		{
			continueReduceBloodEquipEffect.m_probability = ((m_probability > continueReduceBloodEquipEffect.m_probability) ? m_probability : continueReduceBloodEquipEffect.m_probability);
			return true;
		}
