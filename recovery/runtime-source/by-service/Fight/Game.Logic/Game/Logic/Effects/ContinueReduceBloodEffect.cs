...
public class ContinueReduceBloodEffect : AbstractEffect
{
	...
	{
		if (living.EffectList.GetOfType(eEffectType.ContinueReduceBloodEffect) is ContinueReduceBloodEffect continueReduceBloodEffect)
		{
			continueReduceBloodEffect.m_count = m_count;
			return true;
		}
