...
public class SealEquipEffect : BasePlayerEffect
{
	...
	{
		if (living.EffectList.GetOfType(eEffectType.SealEquipEffect) is SealEquipEffect sealEquipEffect)
		{
			sealEquipEffect.m_probability = ((m_probability > sealEquipEffect.m_probability) ? m_probability : sealEquipEffect.m_probability);
			return true;
		}
