...
public class RRCH7202 : AMissionControl
{
	...
	{
		base.OnStartGame();
		base.Game.IsBossWar = "7202";
		SimpleBoss item = base.Game.CreateBoss(bossID, 1565, 787, -1, 1, "standA");
		someBoss.Add(item);
		item = base.Game.CreateBoss(bossID, 1583, 495, -1, 1, "standA");
		someBoss.Add(item);
		item = base.Game.CreateBoss(bossID, 1643, 236, -1, 1, "standA");
		someBoss.Add(item);
	}
