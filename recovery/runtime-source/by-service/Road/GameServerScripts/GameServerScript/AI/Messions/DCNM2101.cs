...
public class DCNM2101 : AMissionControl
{
	...
	{
		base.OnStartGame();
		base.Game.IsBossWar = "2101";
		int num = base.Game.Random.Next(0, npcIDs.Length);
		someNpc.Add(base.Game.CreateNpc(npcIDs[num], 52, 506, 1, 1));
		num = base.Game.Random.Next(0, npcIDs.Length);
		someNpc.Add(base.Game.CreateNpc(npcIDs[num], 100, 507, 1, 1));
		num = base.Game.Random.Next(0, npcIDs.Length);
		someNpc.Add(base.Game.CreateNpc(npcIDs[num], 155, 508, 1, 1));
		num = base.Game.Random.Next(0, npcIDs.Length);
		someNpc.Add(base.Game.CreateNpc(npcIDs[num], 210, 507, 1, 1));
		num = base.Game.Random.Next(0, npcIDs.Length);
		someNpc.Add(base.Game.CreateNpc(npcIDs[num], 253, 507, 1, 1));
		num = base.Game.Random.Next(0, npcIDs.Length);
		someNpc.Add(base.Game.CreateNpc(npcIDs[num], 1275, 508, 1, -1));
		num = base.Game.Random.Next(0, npcIDs.Length);
		someNpc.Add(base.Game.CreateNpc(npcIDs[num], 1325, 506, 1, -1));
		num = base.Game.Random.Next(0, npcIDs.Length);
		someNpc.Add(base.Game.CreateNpc(npcIDs[num], 1360, 508, 1, -1));
		num = base.Game.Random.Next(0, npcIDs.Length);
		someNpc.Add(base.Game.CreateNpc(npcIDs[num], 1410, 506, 1, -1));
		num = base.Game.Random.Next(0, npcIDs.Length);
		someNpc.Add(base.Game.CreateNpc(npcIDs[num], 1475, 508, 1, -1));
	}
	...
	public override void OnNewTurnStarted()
	{
		...
		for (int i = 0; i < 10 - base.Game.GetLivedLivings().Count; i++)
		{
			...
			{
				someNpc.Add(base.Game.CreateNpc(npcIDs[0], x, 506, 1, 1));
			}
		}
	}
