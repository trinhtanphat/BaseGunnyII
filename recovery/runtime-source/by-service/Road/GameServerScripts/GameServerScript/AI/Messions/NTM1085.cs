...
public class NTM1085 : AMissionControl
{
	...
	public override void OnPrepareNewSession()
	{
		...
		int[] npcIds = new int[2] { bossID, blueNpcID };
	...
	public void CreateBoss()
	{
		...
		m_front = base.Game.Createlayer(730, 510, "font", "game.asset.living.boguoLeaderAsset", "out", 1, 0);
		m_boss = base.Game.CreateBoss(bossID, 850, 360, -1, 1, "");
