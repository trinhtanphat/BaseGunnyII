...
public class Labyrinth40039 : AMissionControl
{
	...
	private int[] birthX = new int[10] { 1210, 1190, 1160, 1140, 1120, 300, 280, 260, 240, 220 };
	...
	public override void OnStartGame()
	{
		...
		for (int i = 0; i < birthX.Length; i++)
		{
			if (birthX[i] > 1000)
			{
				someNpc.Add(base.Game.CreateNpc(npcIDs, birthX[i], 171, 1, -1, livingConfig));
			}
			else
			{
				someNpc.Add(base.Game.CreateNpc(npcIDs2, birthX[i], 171, 1, 1));
			}
		}
	}
