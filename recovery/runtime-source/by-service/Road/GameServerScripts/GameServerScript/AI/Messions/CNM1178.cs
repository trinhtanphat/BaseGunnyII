...
public class CNM1178 : AMissionControl
{
	...
	public override void OnPrepareNewSession()
	{
		...
		NpcInfo npcInfoById = NPCInfoMgr.GetNpcInfoById(4);
		base.Game.GameOverResources[0] = npcInfoById.ModelID;
		NpcInfo npcInfoById2 = NPCInfoMgr.GetNpcInfoById(8);
		base.Game.GameOverResources[1] = npcInfoById2.ModelID;
