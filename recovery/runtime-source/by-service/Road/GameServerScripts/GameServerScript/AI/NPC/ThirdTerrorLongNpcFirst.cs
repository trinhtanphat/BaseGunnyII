...
public class ThirdTerrorLongNpcFirst : ABrain
{
	...
	public override void OnStartAttacking()
	{
		...
		if (flag)
		{
			KillAttack(1269, base.Game.Map.Info.ForegroundWidth + 1);
		}
	...
	{
		int num = base.Game.Random.Next(-50, 50);
		base.Body.MoveTo(base.Body.X + num, base.Body.Y, "walk", 1000, "", 3, NextAttack);
	}
	...
	private void NextAttack()
	{
		...
		if (player != null)
		{
			...
			if (base.Body.ShootPoint(player.X, player.Y, 58, 1000, 10000, 3, 2.5f, 2550))
			{
