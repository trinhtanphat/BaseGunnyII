...
public class FourTerrorCattleBoss : ABrain
{
	...
	private static string[] AllAttackChat = new string[3] { "Lần này thế nào hả ?", "你惹毛我了!", "超级无敌大地震……<br/>震……震…… " };
	...
	private static string[] CallChat = new string[1] { "Ngọn lửa câm giận<br/>hãy bừng cháy ...！ " };
