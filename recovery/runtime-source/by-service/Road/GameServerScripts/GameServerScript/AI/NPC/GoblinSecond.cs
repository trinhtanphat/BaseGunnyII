...
public class GoblinSecond : ABrain
{
	...
	{
		m_wallRight = ((PVEGame)base.Game).CreatePhysicalObj(1460, 580, "wallLeft", "", "1", 1, 0);
	...
	private void NextAttack()
	{
		...
		if (player != null && !player.IsFrost && !base.Body.ShootPoint(player.X, player.Y, 56, 1000, 10000, 1, 2.5f, 2000))
		{
		}
	}
