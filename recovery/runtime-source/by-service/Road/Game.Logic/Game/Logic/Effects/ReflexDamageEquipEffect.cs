...
public class ReflexDamageEquipEffect : BasePlayerEffect
{
	...
	{
		if (living.EffectList.GetOfType(eEffectType.ReflexDamageEquipEffect) is ReflexDamageEquipEffect reflexDamageEquipEffect)
		{
			reflexDamageEquipEffect.m_probability = ((m_probability > reflexDamageEquipEffect.m_probability) ? m_probability : reflexDamageEquipEffect.m_probability);
			return true;
		}
