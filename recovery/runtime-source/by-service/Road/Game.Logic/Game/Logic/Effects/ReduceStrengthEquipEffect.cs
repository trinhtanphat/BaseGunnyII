...
public class ReduceStrengthEquipEffect : BasePlayerEffect
{
	...
	{
		if (living.EffectList.GetOfType(eEffectType.ReduceStrengthEquipEffect) is ReduceStrengthEquipEffect reduceStrengthEquipEffect)
		{
			reduceStrengthEquipEffect.m_probability = ((m_probability > reduceStrengthEquipEffect.m_probability) ? m_probability : reduceStrengthEquipEffect.m_probability);
			return true;
		}
