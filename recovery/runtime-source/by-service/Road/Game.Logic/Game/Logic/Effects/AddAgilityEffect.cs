...
public class AddAgilityEffect : BasePlayerEffect
{
	...
	{
		if (living.EffectList.GetOfType(eEffectType.AddAgilityEffect) is AddAgilityEffect addAgilityEffect)
		{
			m_probablity = ((m_probablity > addAgilityEffect.m_probablity) ? m_probablity : addAgilityEffect.m_probablity);
			return true;
		}
