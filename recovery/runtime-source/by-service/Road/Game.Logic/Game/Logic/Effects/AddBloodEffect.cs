...
public class AddBloodEffect : BasePlayerEffect
{
	...
	{
		if (living.EffectList.GetOfType(eEffectType.AddBloodEffect) is AddBloodEffect addBloodEffect)
		{
			m_probability = ((m_probability > addBloodEffect.m_probability) ? m_probability : addBloodEffect.m_probability);
			return true;
		}
