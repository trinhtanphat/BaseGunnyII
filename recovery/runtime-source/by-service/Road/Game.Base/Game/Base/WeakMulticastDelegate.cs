...
public class WeakMulticastDelegate
{
	...
	{
		prev = new WeakMulticastDelegate(realDelegate)
		{
			prev = prev
		};
		return this;
	...
	protected bool Equals(Delegate realDelegate)
	{
		if (weakRef == null)
		{
			return realDelegate.Target == null && method == realDelegate.Method;
		}
		return weakRef.Target == realDelegate.Target && method == realDelegate.Method;
	}
